		...
		<div className="main-page container">
			...
			<div className="items">
				<div className="row" style={{ display: "flex" }}>
					<div className="main-square blue-square col-md-6">
						<img className="square-icon" src="./icons/projectsvg.svg" />
					</div>
					<div className="main-square red-square col-md-6">
						<img className="square-icon" src="./icons/pen.svg" />
					</div>
				</div>
				<div className="row" style={{ display: "flex" }}>
					<div className="main-square yellow-square col-md-6">
						<img className="square-icon" src="./icons/avatar.svg" />
					</div>
					<div className="main-square gunmetal-square col-md-6">
